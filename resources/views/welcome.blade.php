...
<div
    ...
    <div>Сервисных центров: <?= \App\Models\ServiceCenter::query()->count() ?></div>
    <div>Адресов: <?= \App\Models\Address::query()->count() ?></div>
    <div>Событий: <?= \App\Models\Event::query()->count() ?></div>
